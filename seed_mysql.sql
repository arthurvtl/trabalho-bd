...
-- Script de carga inicial de dados - MySQL (Aiven)
-- ----------------------------------------------------------------------------
-- A Secao A reproduz os dados do "8 Scripts de Carga Inicial de Dados" do
-- relatorio. A Secao B traz dados complementares para as tabelas que o
-- relatorio nao populou, apenas para deixar o banco completo. A ordem dos
-- INSERT respeita as chaves estrangeiras.
-- ============================================================================
...
INSERT INTO Horario (id, horario_inicio, horario_fim) VALUES
    (1, '07:00:00', '08:00:00'), (2, '08:00:00', '09:00:00'), (3, '10:00:00', '11:00:00'),
    (4, '18:00:00', '19:00:00'), (5, '19:00:00', '20:00:00');
